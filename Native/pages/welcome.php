...
<head>
    ...
    <link rel="stylesheet" href="../styles/stylesWelcome.css">
    ...
    <main>
        ...
        <section class="second-row">
            ...
            <div class="first-info">
                ...
                <h6>The way we work has changed and Hot desk E-Systems puts you in complete control of your hybrid workspace. It can be easily managed to ensure flexible and safe working, however big or small your organization</h6>
            </div>
        ...
        <section class="first-row">
            ...
            <div class="first-info">
                ...
                <h6>Our simple traffic light system gives you instant information on the state of rooms and desks, and our reports help you gain greater insight into who and how it’s all working. </h6>
            </div>
        ...
        <section class="second-row">
            <div class="first-info">
                ...
                <h6>Brings you the ultimate solution for seamless desk booking. Whether you’re a forward thinking startup, a bustling corporate hub or dynamic coworking space, our Hotdesk Booking Systenm is designed to transform the way you manage and optimise your workspace</h6>
            </div>
            <div class="first-image">
                <img src="../images/image1.png" class="img-fluid">
            </div>
