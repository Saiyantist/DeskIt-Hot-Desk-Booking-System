...
Route::middleware(['auth', 'role:employee|admin', 'verified'])->prefix('booking')->group(function () {
    ...
    // Tinignan ko lang itsura noon wahaha -gelo  
    // Route::get('/booking/desks', [BookingController::class,'showDesks']);
...
Route::middleware(['auth', 'role:admin', 'verified'])->group(function () {
    Route::get('/admin/dashboard', function () {return view('admin.dashboard');})->name('home');
    Route::get('/admin/desk-book', function () {return view('admin.bookBehalf');})->name('book-behalf');
    Route::get('/admin/desk-map', function () {return view('admin.deskMap');})->name('map');
    Route::get('/admin/booking-history', function () {return view('admin.bookingHistory');})->name('history');
