                ...
                <div class="compile">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:mr-6 justify-end">
                        <a href="{{route('profile')}}"
                            class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-full  dark:text-gray-400 bg-yellowB dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150 text-white no-underline">
