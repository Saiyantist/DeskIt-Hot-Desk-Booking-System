    ...
    <section class="bg-pink">
        ...
        <div class="ml-24 mt-4">
            <div class="myBook-container flex flex-row justify-evenly">
                ...
                <div class="w-3/4 h-max" x-data="calendarComponent" x-init="initCalendar">
    ...
    <section class="bg-pink flex justify-center items-center">
        <div class="m-10 ml-24 p-2 flex flex-col bg-white rounded-lg w-[70%] drop-shadow-lg text-lg element-selector">
            <div class="flex justify-between p-2">
                ...
                <a class="no-underline text-block text-lg" wire:navigate href="{{ route('booking-history') }}">Bookings
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
                    Alpine.data('calendarComponent', () => ({
                        ...
                        fetchEvents() {
                            return "{{ route('user.bookings', auth()->id()) }}";
                        },
                    ...
                    Alpine.store('calendarInitialized', true);
                });
    </script>
    @endpush
    @endsection
