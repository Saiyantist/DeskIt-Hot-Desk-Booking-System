                ...
                <div class="m-3 text-center">
                    ...
                    <div class="relative inline-block text-left">
                        <a wire:click="refreshMap" id="nextButton"
                            class="inline-flex items-center justify-center py-2 text-sm font-medium text-white bg-yellowB border border-gray-300 rounded-full w-56 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 no-underline">See
                            Available Desks
                        </a>
                        ...
                        @for ($i = 101; $i <= 136; $i++) <div class="modal-wrapper" data-modal-id="{{ $i }}">
                            ...
                            <div class="modal fixed inset-0 hidden">
                                <div
                                    ...
                                    <button
                                        class="custom-a flex items-center justify-center open-second-modal">Book</button>
                                </div>
                            </div>
            ...
            <div class="bg-gray desk m-4 flex flex-row relative justify-center">
                    ...
                    <div class="flex items-start ">
                        <div class="b-chair m-3">
                            @for ($i = 101; $i < 105; $i++) <a class="modalTrigger" data-modal-id="{{ $i }}"><img
                                    src="{{ asset('images/left-chair.svg') }}" class="flex w-14 my-1" alt="SVG Image"></a>
                                @endfor
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex justify-center items-center">
                        <div class="b-chair m-3">
                            @for ($i = 111; $i < 117; $i++) <a class="modalTrigger" data-modal-id="{{ $i }}"><img
                                    src="{{ asset('images/top-chair.svg') }}" class=" inline-flex h-14" alt="SVG Image"></a>
                                @endfor
                        </div>
                    </div>
                ...
                <div class="ml-10 mr-3 mt-3">
                    ...
                    <div class="b-chair m-3 flex flex-row items-end">
                        <a class="modalTrigger" data-modal-id="129"><img src="{{ asset('images/left-cubic.svg') }}"
                                class=" flex w-14" alt="SVG Image"></a>
                        <a class="modalTrigger" data-modal-id="130"><img src="{{ asset('images/top-cubic.svg') }}"
                                class=" flex h-14" alt="SVG Image"></a>
                    </div>
                    <div class="b-chair flex -m-4 flex-row justify-start items-start">
                        <a class="modalTrigger" data-modal-id="132"><img src="{{ asset('images/bottom-cubic.svg') }}"
                                class=" flex h-14" alt="SVG Image"></a>
                        <a class="modalTrigger" data-modal-id="131"><img src="{{ asset('images/right-cubic.svg') }}"
                                class=" flex w-14" alt="SVG Image"></a>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        {{-- Lower Desks--}}
                        <div class="b-chair m-3 flex flex-row items-end">
                            <a class="modalTrigger" data-modal-id="133"><img src="{{ asset('images/left-cubic.svg') }}"
                                    class=" flex w-14" alt="SVG Image"></a>
                            <a class="modalTrigger" data-modal-id="134"><img src="{{ asset('images/top-cubic.svg') }}"
                                    class=" flex h-14" alt="SVG Image"></a>
                        </div>
                        <div class="b-chair flex -m-4 flex-row justify-start items-start">
                            <a class="modalTrigger" data-modal-id="136"><img src="{{ asset('images/bottom-cubic.svg') }}"
                                    class=" flex h-14" alt="SVG Image"></a>
                            <a class="modalTrigger" data-modal-id="135"><img src="{{ asset('images/right-cubic.svg') }}"
                                    class=" flex w-14" alt="SVG Image"></a>
                        </div>
                    </div>
