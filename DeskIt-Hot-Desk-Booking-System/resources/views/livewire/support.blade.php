         ...
         <div class="flex justify-evenly items-center m-10 text-center">
            ...
            <div class="w-[20%] mb-10">
               ...
               <div class="bg-white rounded-b-xl shadow-md p-4 h-68">
                  ...
                  <p class="text-lg font-light py-2"> Explore Frequently-Asked-Questions for instant problem-solving
                     insights.</p>
                  <button wire:navigate href="{{ route('faq') }}" class="inverter btn btn-warning rounded-xl h-9 w-[80%]">View
                     FAQs</button>
               </div>
            </div>
            ...
            <div class="w-[20%] mb-10">
               ...
               <div class="bg-white rounded-b-xl shadow-md p-4 h-68">
                  ...
                  <button wire:navigate href="{{ route('privacyPolicy') }}" class="inverter btn btn-warning rounded-xl h-9 w-[80%]">View Privacy Policy</button>
               </div>
            </div>
            ...
            <div class="w-[20%] mb-10">
               ...
               <div class="bg-white rounded-b-xl shadow-md p-4 h-68">
                  ...
                  <p class="text-lg font-light py-2 px-3"> Efficiently use every feature with our user-friendly website
                     guide.</p>
                  <button wire:navigate href="{{ route('guides') }}" class="inverter btn btn-warning rounded-xl h-9 w-[80%]">View Guides</button>
               </div>
            </div>
            ...
            @if(Auth::user()->roles->contains('name', 'employee'))
               <div class="w-[20%] mb-10">
                  ...
                  <div class="bg-white rounded-b-xl shadow-md p-4 h-68">
                     ...
                     <button  href="#" data-toggle="modal" data-target="#ModalCreate" class="inverter btn btn-warning rounded-xl h-9 w-[80%]">go to <i class="fa-solid fa-arrow-right"></i></button>
                  </div>
               </div>
            ...
            @else 
               <div class="w-[20%] mb-10">
                  ...
                  <div class="bg-white rounded-b-xl shadow-md p-3 h-68">
                     ...
                     <p class=" text-lg font-light px-3">Check all the submitted issues, and reports/feedbacks of users here.</p>
                     <button wire:navigate href="{{ route('issues') }}" class="inverter mb-2 btn btn-warning rounded-xl h-9 w-[80%]">go to <i class="fa-solid fa-arrow-right"></i></button>
                  </div>
               </div>
            @endif
         </div>
